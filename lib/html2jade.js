...
define(function() {
      ...
      if (!attrs || attrs.length === 0) {
        ...
        for (_i = 0, _len = attrs.length; _i < _len; _i++) {
          ...
          if (attr && (nodeName = attr.nodeName)) {
            if (nodeName !== 'id' && nodeName !== 'class' && typeof (attr.value != null)) {
  ...
  Converter = (function() {
    ...
    Converter.prototype.document = function(document, output, body) {
  ...
  scope.convertDocument = function(document, options, cb) {
    ...
    // console.log(options)
    body = options.body != null ? options.body : false
    // console.log(body)

    options.converter.document(document, output, body);
    if (cb != null) {
      return cb(null, output.final());
    }
  };
 ...
 return {
   ...
   convertDocument: scope.convertDocument
